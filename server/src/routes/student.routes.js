...
router.post('/enroll-subject', requireActiveSubscription, async (req, res) => {
...
router.get('/available-classes', requireActiveSubscription, async (req, res) => {
...
router.post('/message', requireAuth, requireRole('student'), async (req, res) => {
    try {
...
router.get('/conversations', requireAuth, requireRole('student'), async (req, res) => {
...
router.get('/messages/:userId', requireAuth, requireRole('student'), async (req, res) => {
    const studentId = req.user.id;
...
router.get('/bookings', async (req, res) => {
    const bookings = await import('../models/Booking').then(m => m.default.find({ studentId: req.user.id })
...
router.get('/teachers/:teacherId/availability', async (req, res) => {
    ...
    const bookings = await import('../models/Booking').then(m => m.default.find({
        teacherId,
...
router.post('/book-class', requireActiveSubscription, async (req, res) => {
...
router.post('/cancel-booking', async (req, res) => {
    const { bookingId } = req.body;
    await import('../models/Booking').then(m => m.default.findOneAndUpdate({ _id: bookingId, studentId: req.user.id }, { status: 'cancelled' }));
