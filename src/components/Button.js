...
export const Button = ({ variant = 'primary', size = 'md', children, className, ...props }) => {
    return (_jsx("button", { className: clsx('rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-200 focus:ring-offset-2', variants[variant], sizes[size], className), ...props, children: children }));
};
