...
const AdminMessages = () => {
    ...
    const loadConversations = async () => {
        try {
            const convs = await adminApi.getConversations()
    ...
    const handleSelectConversation = async (id: string) => {
        ...
        try {
            const thread = await adminApi.getThread(id)
    ...
    const handleSendMessage = async () => {
        ...
        try {
            await adminApi.sendMessage(activeConversation, chatInput)
            setChatInput('')
            const thread = await adminApi.getThread(activeConversation)
            setChatHistory(thread)
            loadConversations()
        } catch (error) {
            console.error(error)
